...
#ifndef HTTPClientGeneric_H_
#define HTTPClientGeneric_H_
...
/*
 * Since the begin() functions take a reference to client as a parameter, you need to 
 * ensure the client object lives the entire time of the HTTPClientGeneric
 */
...
protected:
    ...
    String _protocol;
    String _headers;
    String _userAgent = "ESP32HTTPClientGeneric";
